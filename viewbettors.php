                ...
                <?php foreach ($getAllBetters as $row): ?>
                    <div class="bettor-card">
                        <div class="bettor-info">
                            ...
                            <p><strong>Created By:</strong> <?php echo htmlspecialchars($row['creator_first_name'] . ' ' . $row['creator_last_name']); ?></p>
                            <p><strong>Date Added:</strong> <?php echo htmlspecialchars($row['date_added']); ?></p>
                            <?php if ($row['last_updated_by']): ?>
                                <p><strong>Last Updated By:</strong> <?php echo htmlspecialchars($row['updater_first_name'] . ' ' . $row['updater_last_name']); ?></p>
