...
<body>
    <div class="container">
        ...
        <div class="confirmation-box">
            <h3>Bettor Name: <?php echo $getBettorByID['bettor_firstname']; ?></h3>
            <h3>Betting Price: <?php echo $getBettorByID['betting_price']; ?></h3>
        </div>
        ...
        <a href="viewbettors.php?color_id=<?php echo $_GET['color_id']; ?>" class="btn">Cancel</a>
    </div>
</body>
</html>